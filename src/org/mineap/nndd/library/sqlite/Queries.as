package org.mineap.nndd.library.sqlite {
    public class Queries {
        ...
        public static const CREATE_TABLE_NNDDVIDEO: String = "CREATE TABLE IF NOT EXISTS nnddvideo (" +
                                                             " id INTEGER PRIMARY KEY," + " key TEXT," + " uri TEXT," +
                                                             " dirpath_id INTEGER," + " videoName TEXT," +
                                                             " isEconomy INTEGER," + " modificationDate REAL," +
                                                             " creationDate REAL," + " thumbUrl TEXT," +
                                                             " playCount REAL," + " time REAL," +
                                                             " lastPlayDate REAL," + " yetReading INTEGER," +
                                                             " pubDate REAL," + " UNIQUE(key));";
        ...
        public static const INSERT_TAGSTRING: String = "INSERT INTO tagstring(" + " tag" + " ) VALUES(" + " :tag" +
                                                       " );";

        public static const INSERT_NNDDVIDEO_TAG: String = "INSERT INTO nnddvideo_tag(" + " nnddvideo_id, tag_id" +
                                                           " ) VALUES(" + " :nnddvideo_id, :tag_id" + " );";

        public static const INSERT_FILE: String = "INSERT INTO file(" + " dirpath" + " ) VALUES(" + " :dirpath" + " );";

        public static const INSERT_VERSION: String = "INSERT INTO version(" + " id, version" + " ) VALUES(" +
                                                     " :id, :version" + " );";
        ...
        public static const UPDATE_NNDDVIDEO: String = "UPDATE nnddvideo SET" + " uri = :uri," + " key = :key," +
                                                       " dirpath_id = :dirpath_id," + " videoName = :videoName," +
                                                       " isEconomy = :isEconomy," +
                                                       " modificationDate = :modificationDate," +
                                                       " creationDate = :creationDate," + " thumbUrl = :thumbUrl," +
                                                       " playCount = :playCount," + " time = :time," +
                                                       " lastPlayDate = :lastPlayDate," + " yetReading = :yetReading," +
                                                       " pubDate = :pubDate" + " WHERE id = :id;";

        public static const UPDATE_TAGSTRING: String = "UPDATE tagstring SET" + " tag = :tag" + " WHERE id = :id;";

        public static const UPDATE_NNDDVIDEO_TAG: String = "UPDATE nnddvideo_tag SET" +
                                                           " nnddvideo_id = :nnddvideo_id," + " tag_id = :tag_id" +
                                                           " WHERE id = :id;";

        public static const UPDATE_VERSION: String = "UPDATE version SET" + " version = :version" + " WHERE id = :id;";
        ...
        public static const SELECT_TAGSTRING_RELATED_BY_NNDDVIDEO_BY_DIR_ID: String = "SELECT * FROM tagstring WHERE id IN (SELECT DISTINCT v_t.tag_id FROM nnddvideo v, nnddvideo_tag v_t WHERE v.dirpath_id = :dirpath_id AND v_t.nnddvideo_id = v.id);";
